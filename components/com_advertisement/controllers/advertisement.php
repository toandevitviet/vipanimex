 ...
 */
class AdvertisementControllerAdvertisement extends AdvertisementController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Advertisement', 'AdvertisementModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_advertisement') || $user->authorise('core.edit.state', 'com_advertisement')) {
            $model = $this->getModel('Advertisement', 'AdvertisementModel');
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_advertisement&view=advertisements', false));
            } else {
    ...
    public function remove() {
        ...
        //Checking if the user can remove object
        $user = JFactory::getUser();
        if ($user->authorise($user->authorise('core.delete', 'com_advertisement'))) {
            $model = $this->getModel('Advertisement', 'AdvertisementModel');
